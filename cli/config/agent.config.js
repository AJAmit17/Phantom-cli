 ...
 */
async function generateApplication(description, model, cwd = process.cwd()) {
    try {
...
- Make it visually appealing and functional`,
        ...
        return {
            ...
            appDir,
            files: application.files.map((f) => ({ path: f.path, description: "" })),
...
module.exports = { generateApplication, ApplicationSchema };
